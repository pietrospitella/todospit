...
/**
  ...
  *
  * @checksum - 8ffe8192f2baa0c6e95fcb314cbeee5596b4ea39204708022cc383a62dc96919
  * @variables - radius=rounded-full,accentColor=blue,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow-none,baseColorShade=500,borderShadeLightMode=100,borderShadeDarkMode=200,inputMaxWidth=max-w-[24em],tagRadius=rounded-full,swatchRadius=rounded-full
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "color__inner": {
    ...
    "group-data-[prefix-icon]:border-neutral-100": true,
    "group-data-[suffix-icon]:border": true,
    "group-data-[suffix-icon]:border-neutral-100": true,
    "dark:group-data-[prefix-icon]:border-neutral-200": true,
    "dark:group-data-[suffix-icon]:border-neutral-200": true
  },
  "color__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "submit__input": {
    ...
    "disabled:border-neutral-100": true,
  ...
  "slider__minValue": {
    ...
    "[&>div>div::after]:bg-neutral-100": true,
    "dark:[&>div>div::after]:bg-neutral-200": true
  },
  "slider__maxValue": {
    "grow": true,
    "!max-w-[45%]": true,
  ...
  "transferlist__transferlistListItem": {
    ...
    "dark:ring-neutral-400": true,
    "dark:data-[is-active=true]:ring-blue-400": true,
    "dark:aria-selected:ring-blue-400": true,
  ...
  "multi-step__tabs": {
    ...
    "dark:group-data-[tab-style=tab]/wrapper:border-neutral-300": true,
